...
public class Materia {
    ...
    private void coleccionNotasEstaticas(){
    ...
    public void adicionarNota(int pNota_100){
        //Construir la nota a partir de la calificación recibida
        Nota notaRecibida = new Nota (pNota_100);
        //Coleccionamos la nota
    ...
    public void mostrarMateria(){
        ...
        this.estudianteCursando.mostrarInfoEstudiante(); //Asociación
    ...
    public void calcularPromedio(int porColeccion){ //Cualquier valor entero indica promedio sobre colección
        double sumatoria = 0;
        for (Nota nota : notasColeccion) {
            sumatoria += nota.getEscala5();
        }
        this.promedio = sumatoria / notasColeccion.size();
    }
